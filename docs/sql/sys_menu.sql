...
INSERT INTO sys_menu (id, menu_name, menu_type, status_id, sort, parent_id, menu_url, api_url, menu_icon, remark, create_time, update_time) VALUES (3, '用户管理', 2, 1, 3, 2, '/user', '/api/user_list', '', '用户管理', '2022-07-14 17:40:10', '2022-07-14 17:40:10');
